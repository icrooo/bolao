-- Add updated_at to matches to track real timing of score changes
...
-- Extend get_ranking with p_only_finished to allow computing "official" ranking (used for position diff baseline)
CREATE OR REPLACE FUNCTION public.get_ranking(
  p_date date DEFAULT NULL,
  p_group_id uuid DEFAULT NULL,
  p_only_finished boolean DEFAULT false
)
