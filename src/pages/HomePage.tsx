        ...
        <section className="space-y-3">
          ...
          <div className="glass-card p-4">
            <div className="flex items-start justify-between gap-3">
              <div>
                <h4 className="font-medium">Placar exato</h4>
          ...
          <div className="glass-card p-4">
            <div className="flex items-start justify-between gap-3">
              <div>
                <h4 className="font-medium">Tendência certa</h4>
                <p className="text-sm text-muted-foreground">Acertou o vencedor (ou empate), mas não o placar.</p>
                <p className="text-xs text-muted-foreground mt-1">Ex.: palpite 2x1 · resultado 3x0</p>
              </div>
          ...
          <div className="glass-card p-4">
            <div className="flex items-start justify-between gap-3">
              <div>
                <h4 className="font-medium">Tendência errada</h4>
                <p className="text-sm text-muted-foreground">Errou totalmente quem ganhou.</p>
                <p className="text-xs text-muted-foreground mt-1">Ex.: palpite 2x1 · resultado 0x3</p>
              </div>
          ...
          <div className="glass-card p-4">
            <div className="flex items-start justify-between gap-3">
              <div>
                <h4 className="font-medium">Esqueceu de palpitar</h4>
